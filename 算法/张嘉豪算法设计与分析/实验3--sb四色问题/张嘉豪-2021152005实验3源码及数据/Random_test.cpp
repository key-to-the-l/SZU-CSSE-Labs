...
void read()         //读取文件数据
{
    cout<<"START"<<endl;
    ifstream file1;
    //file1.open("C:\\Users\\78047\\Desktop\\vsc\\.vscode\\Experiment3\\50p_200e_4a.txt");
    //file1.open("C:\\Users\\78047\\Desktop\\vsc\\.vscode\\Experiment3\\100p_420e_4a.txt");
    //file1.open("C:\\Users\\78047\\Desktop\\vsc\\.vscode\\Experiment3\\150p_666e_4a.txt");
    file1.open("C:\\Users\\78047\\Desktop\\vsc\\.vscode\\Experiment3\\200p_900e_4a.txt");
...
void MRV_DH_SEARCH(int num)     //MRV和DH剪枝优化
{
    if(num>n)           //所有点的颜色都涂完
    {
        ...
        if(cnt==40000000)
        {
            clock_t t_temp;
            t_temp=clock();
            cout<<"Time to get the 1e7 solution:";
